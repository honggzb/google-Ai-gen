  ...
  return (
    <>
      <div className="relative bg-cover bg-center"
        style={{ backgroundImage: 'url("/background.jpg")', height: "50vh" }}>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <PromoCard
                ...
                description="Labore Lorem sint consequat ea. Aliqua officia mollit mollit est ea aliqua cillum labore est"
                link="/dashboard" />
              <PromoCard
