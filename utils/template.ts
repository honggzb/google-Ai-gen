export default [
  ...
  },
  {
    ...
    desc: "An AI tool that suggests SEO-friendly keywords for your topic",
    category: "SEO",
    icon: "https://cdn-icons-png.flaticon.com/128/3792/3792134.png",
    aiPrompt: "Provide 5 SEO keywords for: ",
    slug: "ai-seo-keywords",
    form: [
      {
        label: "Enter your main topic",
        field: "input",
        name: "topic",
        required: true
      }
  ...
  },
  {
    ...
    desc: "An AI tool to create engaging product descriptions based on input",
    category: "E-commerce",
    icon: "https://cdn-icons-png.flaticon.com/128/3074/3074406.png",
  ...
  },
  {
    ...
    desc: "Generates ideas for engaging social media posts",
    category: "Social Media",
    icon: "https://cdn-icons-png.flaticon.com/128/3050/3050246.png",
    aiPrompt: "Give 5 creative social media post ideas for: ",
    slug: "ai-social-media-posts",
    form: [
      {
  ...
  },
  {
    ...
    desc: "Creates catchy email subject lines to improve open rates",
    category: "Email Marketing",
    icon: "https://cdn-icons-png.flaticon.com/128/3767/3767068.png",
    aiPrompt: "Give 5 email subject line suggestions for: ",
    slug: "ai-email-subject",
    form: [
      {
        label: "Enter the email topic",
        field: "input",
        name: "emailTopic",
        required: true
      }
  ...
  },
  {
    ...
    desc: "An AI tool that generates ad copy for digital advertising",
    category: "Marketing",
    icon: "https://cdn-icons-png.flaticon.com/128/3281/3281305.png",
    aiPrompt: "Write ad copy for: ",
    slug: "ai-ad-copy",
    form: [
      {
  ...
  },
  {
    ...
    desc: "Generates relevant hashtags for social media content",
    category: "Social Media",
    icon: "https://cdn-icons-png.flaticon.com/128/3523/3523063.png",
    aiPrompt: "Provide 5 hashtags for: ",
  ...
  {
    name: "Slogan Creator",
    desc: "Generates catchy slogans for businesses or campaigns",
    category: "Branding",
    icon: "https://cdn-icons-png.flaticon.com/128/2350/2350840.png",
    aiPrompt: "Create a slogan for: ",
    slug: "ai-slogan-creator",
    form: [
      {
        label: "Enter the business or campaign",
        field: "input",
        name: "business",
        required: true
      }
  ...
  },
  {
    ...
    desc: "Generates strong bullet points for resumes based on your experience",
    category: "Career",
    icon: "https://cdn-icons-png.flaticon.com/128/3143/3143460.png",
    aiPrompt: "Create resume bullet points for: ",
    slug: "ai-resume-bullets",
    form: [
      {
        label: "Enter your job title or skills",
        field: "input",
        name: "jobTitle",
        required: true
      }
  ...
  },
  {
    ...
    desc: "Generates SEO-optimized title tags for web pages",
    category: "SEO",
    icon: "https://cdn-icons-png.flaticon.com/128/854/854866.png",
    aiPrompt: "Give 5 title tag ideas for: ",
    slug: "ai-title-tags",
    form: [
      {
        label: "Enter the page topic",
        field: "input",
        name: "pageTopic",
        required: true
      }
  ...
  },
  {
    ...
    desc: "Creates SEO-friendly meta descriptions for web pages",
    category: "SEO",
    icon: "https://cdn-icons-png.flaticon.com/128/888/888847.png",
    aiPrompt: "Write a meta description for: ",
    slug: "ai-meta-description",
    form: [
      {
        label: "Enter the page content or topic",
        field: "input",
        name: "pageContent",
        required: true
      }
  ...
  {
    name: "FAQ Generator",
    desc: "Generates frequently asked questions for a given topic",
    category: "Customer Support",
    icon: "https://cdn-icons-png.flaticon.com/128/3075/3075903.png",
    aiPrompt: "Give 5 FAQs for: ",
  ...
  },
  {
    ...
    desc: "Creates innovative job titles for roles within companies",
    category: "Career",
    icon: "https://cdn-icons-png.flaticon.com/128/1094/1094960.png",
    aiPrompt: "Generate a job title for: ",
    slug: "ai-job-title-generator",
    form: [
      {
        label: "Enter the job role or company",
        field: "input",
        name: "jobRole",
        required: true
      }
